...
function SummonerTier(tier, rank) {
    ...
    tier_div.style.background = `url(http://carrygg-env-1.eba-e26mm6jp.ap-northeast-2.elasticbeanstalk.com/client/asset/ranked-emblems/Emblem_${tier}.png) center center / cover`;
